...
PREPROCESS_JOB="${SCRIPT_DIR}/preprocess_mpi_fairing_grid_proteins.sbatch"
...
echo "Submitting fairing preprocess job..."
PREPROCESS_ID="$(sbatch --parsable "${PREPROCESS_JOB}")"
echo "  preprocess job id: ${PREPROCESS_ID}"

echo "Submitting fairing train job with dependency afterok:${PREPROCESS_ID}..."
